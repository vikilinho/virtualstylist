      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="text-center py-16 md:py-20">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-lg text-slate-600">
            Upload a piece of clothing and let our AI create three complete looks for you.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className={`flex-col space-y-6 lg:col-start-1 lg:row-start-1 ${!uploadedImage ? 'hidden' : 'flex'}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="flex-1 w-full inline-flex items-center justify-center gap-2 px-6 py-3 bg-blue-600 text-white font-semibold rounded-full shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 disabled:bg-slate-400 disabled:cursor-not-allowed transform hover:scale-105"
              >
                {isLoading ? (
                  <>
              ...
              <button
                onClick={handleReset}
                className="w-full sm:w-auto px-6 py-3 bg-white text-slate-700 font-semibold rounded-full border border-slate-300 hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200"
              >
                Start Over
              </button>
            </div>
          ...
          <div className={`bg-white p-6 sm:p-8 rounded-3xl shadow-sm border border-slate-200/80 min-h-[300px] ${!uploadedImage ? 'lg:col-span-2' : 'lg:col-start-2'}`}>
            ...
            <p className="text-slate-500 mb-6">Three unique looks styled by AI, just for you.</p>
            <OutfitDisplay 
